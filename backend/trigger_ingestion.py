...
def main():
    ...
    print("This will fetch all emails from your IMAP inbox and process them with AI services.")
    print()
    ...
    try:
        ...
        print(f"✅ Email ingestion task queued successfully!")
        ...
        print()
        print("⏰ This process may take a few minutes depending on the number of emails.")
